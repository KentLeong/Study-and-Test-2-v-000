...
Subcategory.create(name:"Biology", category_id: 5)
    ...
    Concept.create(name:"Addition", subcategory_id:1, category_id:1, description:"Adding numbers")
    ...
    Concept.create(name:"Subtraction", subcategory_id:1, category_id:1, description:"subtracting numbers")
    ...
    Concept.create(name:"Division", subcategory_id:1, category_id:1, description:"dividing numbers")
    ...
    Concept.create(name:"Multiplication", subcategory_id:1, category_id:1, description:"multiplying numbers")
    ...
    Concept.create(name:"Pythagorean Theorem", subcategory_id:2, category_id:1, description:"doing math numbers")
